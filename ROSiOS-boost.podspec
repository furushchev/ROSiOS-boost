#
# Be sure to run `pod lib lint ROSiOS-boost.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  s.description      = <<-DESC
Pre-built Boost C++ Library for ROSiOS
                       DESC

  s.homepage         = "https://github.com/ros-ios/ROSiOS-boost"
  s.license          = 'Boost'
  s.author           = { "Furushchev" => "furushchev@jsk.imi.i.u-tokyo.ac.jp" }
  s.source           = { :git => "https://github.com/ros-ios/ROSiOS-boost.git", :tag => s.version.to_s }
